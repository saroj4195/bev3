...
/**
* Paytm Payment getway encode and decode
*@author : Ranjit @Date : 20-05-2020
*@userstory : This controller is used to handle paytm transection needed data
*/
class PaytmEncdecController extends Controller
{
  ...
  public function getTxnStatus($requestParamList) {
    return callAPI('https://securegw.paytm.in/order/status', $requestParamList);
  }

  public function getTxnStatusNew($requestParamList) {
    return callNewAPI('https://securegw.paytm.in/order/status', $requestParamList);
  }

  public function initiateTxnRefund($requestParamList) {
    $CHECKSUM = $this->getRefundChecksumFromArray($requestParamList,'_lSeS54hbAD5Vk5S',0);
