...
use DB;
use App\Http\Controllers\CrsReservationController;
use App\Role;
use App\AdminUser;
...
/*$success=$this->crs_reservation->successBooking(5381, '13a816ff4fd99149b12b2cbfdc08bc61', 'Net Booking', "#######",  201807285377);
if($success)
{                 
...
$success=$this->crs_reservation->successBooking($id, $mihpayid, $payment_mode, $hash, $txnid);
if($success)
{                 
            $res="Payment received successfully,please check your email account for details";
return response()->json($res);   
