...
class CrsBookingsTest2Controller extends Controller
{
    private $rules=array(
        'from_date'=>'required',
        'to_date'=>'required',
    ...
    public function crsBookingMail($invoice_id,$payment_type,$mail_type){
        ...
        'hotel_booking.rooms','invoice_table.hotel_id','invoice_table.extra_details','crs_booking.guest_remark','invoice_table.discount_amount','invoice_table.tax_amount','crs_booking.adult','crs_booking.child','crs_booking.guest_name','crs_booking.valid_hour','crs_booking.payment_type','crs_booking.validity_type')
        ...
        'total_child'=>$total_child,'check_in_time'=>$hoteldetails->check_in_time,'check_out_time'=>$hoteldetails->check_out_time,'booking_info'=>$booking_info,'no_of_nights'=>$no_of_nights,'rate_plan'=>$rate_plan->plan_name,'payment_type'=>$details->payment_type,'valid_hour'=>$details->valid_hour,'validity_type'=>$details->validity_type);
