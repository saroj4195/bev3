<?php
namespace App\Http\Controllers\Extranetv4\worldline;
use App\Http\Controllers\Controller;
use App\Http\Controllers\Extranetv4\worldline\ResMsgDTO;
use App\Http\Controllers\Extranetv4\worldline\VtransactSecurity;
use App\Http\Controllers\Extranetv4\worldline\HTTPPost;
use App\Http\Controllers\Extranetv4\worldline\ReqMsgDTO;
class Awlmeapi extends Controller
{
	/**
 ...
 */
	protected $resmsgdto;
    protected $vtransactsecurity;
    protected $httppost;
    protected $reqmsgdto;
   public function __construct(ResMsgDTO $resmsgdto, VtransactSecurity $vtransactsecurity, HTTPPost $httppost, ReqMsgDTO $reqmsgdto)
    {
       $this->resmsgdto = $resmsgdto;
       $this->vtransactsecurity=$vtransactsecurity;
       $this->httppost = $httppost;
       $this->reqmsgdto = $reqmsgdto;
    }
	public function generateTrnReqMsg($reqMsgDTO)
        { //echo $reqMsgDTO; die;
		...
		if($reqMsgDTO->getAddField9()==""){
			...
			$vTransactSecurity =$this->vtransactsecurity;
	...
	public function parseTrnResMsg($enc_data, $enc_key)
		{ 
	...
	public function getTransactionStatus($mid, $orderid, $pgmetrn,$enc_key)
		{ 
						$enc_data=null;
						$dec_data = null;
 ...
 /**
	 ...
	 * @throws Exception
	 */
    public function cancelTransaction($reqMsgDTO)
        {
		...
		public function refundTransaction($reqMsgDTO)
	...
	public function generateTrnReqMsgWithCard($reqMsgDTO)
        {  
			if($reqMsgDTO->getAddField10()=="" ){
				$reqMsgDTO->setAddField10("NA");
			}
