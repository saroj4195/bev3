...
class LogsControllerTest extends Controller
{
...
* @auther ranjit
*/
public function inventoryDetails(int $hotel_id,string $to_date,int $room_type_id,int $selected_be_ota_id,Request $request)
{
...
* @auther ranjit
*/
public function rateplanDetails(int $hotel_id,string $to_date,int $rate_plan_id,int $selected_be_ota_id,int $room_type_id,Request $request)
{
        dd('here');
        $from_date=date("Y-m-d", strtotime($to_date.'-7 days'));
        $to_date=date("Y-m-d", strtotime($to_date));
...
* @auther ranjit
*/
public function userSession(int $hotel_id,string $to_date,Request $request)
{
