...
Dear ,<br/>
Password reset for your account was requested .</span></p>
<p style="font-size:15px;margin-top:30px;">Please,Click the link given below to reset password of your account with bookingjini. </p>
<a href="{{$verify_code}}"><button class="button"><span><b> Click here to reset</b> </span></button></a>
</td>
<td width="30"><p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p></td>
</tr>
</tbody>
