                                         ...
                                         <table cellspacing="0" cellpadding="0" border="0" width="100%" bgcolor="#fff3e0" style="border-bottom:2px solid #e78048">
                                             <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        @if($payment_type == '1')
                                                            <a href="http://be.bookingjini.com/crs/crs_pay/'<?=$booking_info?>'"><button class="button"><span><b> <i style="font-size:18px;color:#EB4E16"></i>Pay Now<span>&#8377;<?=$paid?></span></b> </span></button></a>
                                                        @endif
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <section style="float:left;padding-left:15px;">
                                                                ...
                                                                <h4 >We hope this email finds you well. Thank you for choosing <span><?=$hotel_display_name?></span> as your property of choice for your visit and booking through our hotel's website. Your booking modification details have been provided below:</h4>
                                                            </section>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <fieldset style="margin:10px;">
                                                                <legend class="legend-header">BOOKING DETAILS</legend>
                                                                    ...
                                                                    <section style="float:right; width: 50%;">
                                                                        ...
                                                                        <font class="legend-content">&#8377;<?=$room_price?></font>
                                                                    </section>
                                                            </fieldset>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td>
                                                            <fieldset style="margin:10px;">
                                                                <legend class="legend-header">PRICE DETAILS</legend>
                                                                    ...
                                                                    <section style="float:right;width: 50%;">
                                                                        <i style="font-size:15px;color:#434343;"></i> <font class="legend-font"><b>TOTAL AMOUNT TO BE PAID :</b></font> <font class="legend-content">&#8377;<?=$paid?></font>
                                                                    </section>
                                                            </fieldset>
                                                        </td>
                                                    </tr>         
                                                        ...
                                                        <td>
                                                            ...
                                                            <section style="float:left;padding-left:15px;">
                                                                ...
                                                                <span style="color:red;">
                                                                    ...
                                                                    <br>
                                                                    @if($validity_type == '1')
                                                                        - Payment link is valid upto <span><?=$valid_hour?></span> hours.
                                                                    @else
                                                                        - Payment link is valid upto <span><?=$valid_hour?></span> days.
                                                                    @endif
                                                                </span>
                                                                <br><br>
                                                                @endif
