...
{?>
<tr class="row">
<td class="col-md-3"><font class="legend-content"><?=sizeof($room_type)==$rooms ? $room_type[$i] : $room_type[0] ?></font></td>
<td class="col-md-3"><font class="legend-content"><?=$rate_plan?></font></td>
<td class="col-md-2"><font class="legend-content">1</font></td>
...
<section>
                                                                                    <i id="icon-font" class=""></i> <font class="legend-font">Amount before tax : </font> <font class="legend-content">&#8377;<?= $total_amount ?></font><br/>
</section>
                                                                            <section>
<i id="icon-font" class=""></i><font class="legend-font"> Tax Amount : </font> <font class="legend-content">&#8377;<?=$tax_amount?></font><br/>
                                                                            </section> 
<section>
