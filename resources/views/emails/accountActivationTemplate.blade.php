...
Dear ,<a href="https://admin.bookingjini.com"><button class="button"><span><b>Open Dashboard</b> </span></button></a><br/>
<?=$details['first_name']?><?= $details['last_name']?> </span></p><br/>
<p style="font-size:14px;">
Your credential with bookingjini are as followes<br/><br/>
<font class="legend-font">Username: </font> <font class="legend-content"><b><?=$details['username']?></b></font>
<font class="legend-font"><b>&</b> Password: </font> <font class="legend-content"><b><?=$details['password']?></b></font><br/>
</p>
<p style="font-size:18px;margin-left: 400px;">Thank you.<br/></p>
</td>
<td width="30"><p style="margin:0; font-size:1px; line-height:1px;">&nbsp;</p></td>
                                                            </tr>
</tbody>
